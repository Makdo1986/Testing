...
Resource  ../resources/buy-back_page.resource
...
Test improvisé 1
    When I click on menu Services & Voyages
    And I click on Revendre mon matériel
    Then the slider Comment ça marche is opened
    And the titles of sections are correctly displayed
